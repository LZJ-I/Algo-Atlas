...
所谓“工欲善其事，必先利其器”，配置好环境可以让坐在电脑前刷题变的更加快乐：[vscode/cursor 刷题插件](https://labuladong.online/zh/algo/intro/vscode/)

这里我用的**不是官方的LeetCode插件**，因为他的登录经常有问题。这个作为第三方插件有些广告，但不影响体验
